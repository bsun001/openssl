/*
    To compile:
    gcc -g client22.c common.c -o client22 -L/usr/lib64 -lpthread -I/usr/local/ssl/lib -L/usr/local/ssl/lib -lcrypto -lssl
...
//  SSL_CTX_set_verify(ctx, SSL_VERIFY_NONE, NULL); // verify_callback);
...
int main(int argc, char *argv[])
{
    ...
    int_info("From client2. Calling SSL_connect()");
